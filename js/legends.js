...
export const ranLegend =
  "Le Ranger est un pisteur discret, aussi agile avec un arc qu’une trousse de crochetage. Pas très éduqué, ni magicien…";

export const skaLegend =
  "Le Skald est un musicien extravagant mais polyvalent au combat. Avec une lyre, on peut faire de la magie mais on peut aussi taper avec…";
...
export const wulLegend =
  "Tribut du Loup. Ils sont plus à l'aise en forêt que dans une ville. Pisteurs hors pairs, ils ont un vision affutée qui leur montre des détails invibiles aux yeux des chasseurs les plus aggeris. Ascétique par tradition, leur consitution n'a d'égal que leur humour...";

export const ravLegend =
  "Tribut du Corbeau. Les natifs de ce peuple sont particulièrement proche des dieux. Leur éducation stricte dans les domaines intellectuels est telle qu'ils n'ont pas beaucoup de temps à consacrer aux activités physiques.";
